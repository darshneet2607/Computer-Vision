...
datadir    = 'UCS532_Assignment1_2021/data'      # the directory containing the images
resultsdir = 'UCS532_Assignment1_2021/results'   # the directory for dumping results
...
for file in os.listdir(datadir):
    if file.endswith('.jpg'):
        ...
        #fname = '%s/%s_01edge_compareWithCanny.png' % (resultsdir, file)
        #cv2.imwrite(fname, edged)
